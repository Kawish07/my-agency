...
<div className="h-[90vh] md:h-[100vh] bg-cover bg-center" style={{ backgroundImage: "url('images/Testimonial.png')" }} />
                <div className="flex items-center justify-center p-12">
                    <div className="max-w-xl">
                        ...
                        <button onClick={() => window.dispatchEvent(new CustomEvent('openContactModal'))} className="border border-black px-6 py-3 text-sm hover:bg-black hover:text-white transition-colors">Contact Philip</button>
                    </div>
                </div>
            </section>
            ...
            <section className="relative h-[60vh] md:h-[70vh] w-full">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
                    <h2 className="text-white text-4xl md:text-5xl font-serif mb-4">Work with Philip</h2>
